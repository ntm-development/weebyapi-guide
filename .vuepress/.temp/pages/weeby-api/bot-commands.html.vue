<template><h1 id="bot-commands" tabindex="-1"><a class="header-anchor" href="#bot-commands" aria-hidden="true">#</a> Bot commands</h1>
<p>The Weeby API bot uses slash commands which can be run in the server.</p>
<DiscordMessages>
